...
class CPU6502 (val bus: Bus) {
    ...
    val opcodeTable: Map<UByte, () -> Unit> = mapOf(
        ...
        (0x60u).toUByte() to { III().execute() },
        (0x61u).toUByte() to { III().execute() },
        (0x65u).toUByte() to { III().execute() },
        (0x66u).toUByte() to { III().execute() },
        (0x68u).toUByte() to { III().execute() },
        (0x69u).toUByte() to { III().execute() },
        (0x6Au).toUByte() to { III().execute() },
        (0x6Cu).toUByte() to { III().execute() },
        (0x6Du).toUByte() to { III().execute() },
        (0x6Eu).toUByte() to { III().execute() },

        (0x70u).toUByte() to { III().execute() },
        (0x71u).toUByte() to { III().execute() },
        (0x75u).toUByte() to { III().execute() },
        (0x76u).toUByte() to { III().execute() },
        (0x78u).toUByte() to { III().execute() },
        (0x79u).toUByte() to { III().execute() },
        (0x7Du).toUByte() to { III().execute() },
        (0x7Eu).toUByte() to { III().execute() },

        (0x81u).toUByte() to { III().execute() },
        (0x81u).toUByte() to { III().execute() },
        (0x84u).toUByte() to { III().execute() },
        (0x85u).toUByte() to { III().execute() },
        (0x86u).toUByte() to { III().execute() },
        (0x88u).toUByte() to { III().execute() },
        (0x8Au).toUByte() to { III().execute() },
        (0x8Cu).toUByte() to { III().execute() },
        (0x8Du).toUByte() to { III().execute() },
        (0x8Eu).toUByte() to { III().execute() },

        (0x90u).toUByte() to { III().execute() },
        (0x91u).toUByte() to { III().execute() },
        (0x94u).toUByte() to { III().execute() },
        (0x95u).toUByte() to { III().execute() },
        (0x96u).toUByte() to { III().execute() },
        (0x98u).toUByte() to { III().execute() },
        (0x99u).toUByte() to { III().execute() },
        (0x9Au).toUByte() to { III().execute() },
        (0x9Du).toUByte() to { III().execute() },

        (0xA0u).toUByte() to { III().execute() },
        (0xA1u).toUByte() to { III().execute() },
        (0xA2u).toUByte() to { III().execute() },
        (0xA4u).toUByte() to { III().execute() },
        (0xA5u).toUByte() to { III().execute() },
        (0xA6u).toUByte() to { III().execute() },
        (0xA8u).toUByte() to { III().execute() },
        (0xA9u).toUByte() to { III().execute() },
        (0xAAu).toUByte() to { III().execute() },
        (0xACu).toUByte() to { III().execute() },
        (0xADu).toUByte() to { III().execute() },
        (0xAEu).toUByte() to { III().execute() },

        (0xB0u).toUByte() to { III().execute() },
        (0xB1u).toUByte() to { III().execute() },
        (0xB4u).toUByte() to { III().execute() },
        (0xB5u).toUByte() to { III().execute() },
        (0xB6u).toUByte() to { III().execute() },
        (0xB8u).toUByte() to { III().execute() },
        (0xB9u).toUByte() to { III().execute() },
        (0xBAu).toUByte() to { III().execute() },
        (0xBCu).toUByte() to { III().execute() },
        (0xBDu).toUByte() to { III().execute() },
        (0xBEu).toUByte() to { III().execute() },

        (0xC0u).toUByte() to { III().execute() },
        (0xC1u).toUByte() to { III().execute() },
        (0xC4u).toUByte() to { III().execute() },
        (0xC5u).toUByte() to { III().execute() },
        (0xC6u).toUByte() to { III().execute() },
        (0xC8u).toUByte() to { III().execute() },
        (0xC9u).toUByte() to { III().execute() },
        (0xCAu).toUByte() to { III().execute() },
        (0xCCu).toUByte() to { III().execute() },
        (0xCDu).toUByte() to { III().execute() },
        (0xCEu).toUByte() to { III().execute() },

        (0xD0u).toUByte() to { III().execute() },
        (0xD1u).toUByte() to { III().execute() },
        (0xD5u).toUByte() to { III().execute() },
        (0xD6u).toUByte() to { III().execute() },
        (0xD8u).toUByte() to { III().execute() },
        (0xD9u).toUByte() to { III().execute() },
        (0xDDu).toUByte() to { III().execute() },
        (0xDEu).toUByte() to { III().execute() },

        (0xE0u).toUByte() to { III().execute() },
        (0xE1u).toUByte() to { III().execute() },
        (0xE4u).toUByte() to { III().execute() },
        (0xE5u).toUByte() to { III().execute() },
        (0xE6u).toUByte() to { III().execute() },
        (0xE8u).toUByte() to { III().execute() },
        (0xE9u).toUByte() to { III().execute() },
        (0xEAu).toUByte() to { III().execute() },
        (0xECu).toUByte() to { III().execute() },
        (0xEDu).toUByte() to { III().execute() },
        (0xEEu).toUByte() to { III().execute() },

        (0xF0u).toUByte() to { III().execute() },
        (0xF1u).toUByte() to { III().execute() },
        (0xF5u).toUByte() to { III().execute() },
        (0xF6u).toUByte() to { III().execute() },
        (0xF8u).toUByte() to { III().execute() },
        (0xF9u).toUByte() to { III().execute() },
        (0xFDu).toUByte() to { III().execute() },
        (0xFEu).toUByte() to { III().execute() },

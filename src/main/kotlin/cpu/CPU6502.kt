...
class CPU6502(override var bus: Mediator) : Component {
    ...
    private val opcodeTable: Map<UByte, Triple<AddressingMode, Operation, Int>> = mapOf(
        ...
        (0x10u).toUByte() to Triple(AddressingMode.REL, BPL(), 0),
        ...
        (0x30u).toUByte() to Triple(AddressingMode.REL, BMI(), 0),
        (0x31u).toUByte() to Triple(AddressingMode.IND_Y, AND(), 0),
        ...
        (0x39u).toUByte() to Triple(AddressingMode.ABS_Y, AND(), 0),
        (0x3Du).toUByte() to Triple(AddressingMode.ABS_X, AND(), 0),
        ...
        (0x50u).toUByte() to Triple(AddressingMode.REL, BVC(), 0),
        ...
        (0x70u).toUByte() to Triple(AddressingMode.REL, BVS(), 0),
        (0x71u).toUByte() to Triple(AddressingMode.IND_Y, ADC(), 0),
        ...
        (0x79u).toUByte() to Triple(AddressingMode.ABS_Y, ADC(), 0),
        (0x7Du).toUByte() to Triple(AddressingMode.ABS_X, ADC(), 0),
        (0x7Eu).toUByte() to Triple(AddressingMode.ABS_X, ROR(), 7),
        (0x81u).toUByte() to Triple(AddressingMode.X_IND, STA(), 0),
        (0x84u).toUByte() to Triple(AddressingMode.ZPG, STY(), 0),
        (0x85u).toUByte() to Triple(AddressingMode.ZPG, STA(), 0),
        (0x86u).toUByte() to Triple(AddressingMode.ZPG, STX(), 0),
        (0x88u).toUByte() to Triple(AddressingMode.IMP, DEY(), 2),
        (0x8Au).toUByte() to Triple(AddressingMode.IMP, TXA(), 0),
        (0x8Cu).toUByte() to Triple(AddressingMode.ABS, STY(), 0),
        (0x8Du).toUByte() to Triple(AddressingMode.ABS, STA(), 0),
        (0x8Eu).toUByte() to Triple(AddressingMode.ABS, STX(), 0),
        (0x90u).toUByte() to Triple(AddressingMode.REL, BCC(), 0),
        (0x91u).toUByte() to Triple(AddressingMode.IND_Y, STA(), 0),
        (0x94u).toUByte() to Triple(AddressingMode.ZPG_X, STY(), 0),
        (0x95u).toUByte() to Triple(AddressingMode.ZPG_X, STA(), 0),
        (0x96u).toUByte() to Triple(AddressingMode.ZPG_Y, STX(), 0),
        (0x98u).toUByte() to Triple(AddressingMode.IMP, TYA(), 0),
        (0x99u).toUByte() to Triple(AddressingMode.ABS_Y, STA(), 0),
        (0x9Au).toUByte() to Triple(AddressingMode.IMP, TXS(), 0),
        (0x9Du).toUByte() to Triple(AddressingMode.ABS_X, STA(), 0),
        ...
        (0xA8u).toUByte() to Triple(AddressingMode.IMP, TAY(), 0),
        (0xA9u).toUByte() to Triple(AddressingMode.IMM, LDA(), 2),
        (0xAAu).toUByte() to Triple(AddressingMode.IMP, TAX(), 0),
        ...
        (0xB0u).toUByte() to Triple(AddressingMode.REL, BCS(), 0),
        ...
        (0xBAu).toUByte() to Triple(AddressingMode.IMP, TSX(), 0),
        ...
        (0xC8u).toUByte() to Triple(AddressingMode.IMP, INY(), 0),
        ...
        (0xDEu).toUByte() to Triple(AddressingMode.ABS_X, DEC(), 0),
        ...
        (0xF0u).toUByte() to Triple(AddressingMode.REL, BEQ(), 0),
        (0xF1u).toUByte() to Triple(AddressingMode.IND_Y, SBC(), 0),
        ...
        (0xF9u).toUByte() to Triple(AddressingMode.ABS_Y, SBC(), 0),
        (0xFDu).toUByte() to Triple(AddressingMode.ABS_X, SBC(), 0),
